...
const runComparison = () => {
  ...
  leftSideStats.forEach((leftStat, index) => {
    ...
    const righValue = parseInt(rightStat.dataset.value);

    if (righValue > leftValue) {
...
<p class="subtitle">Metascpre</p>
</article><article  data-value=${Rating} class="notification is-primary">
<p class="title">${movieDetail.imdbRating}</p>
<p class="subtitle">IMDB Rating</p>
</article><article data-value=${Votes} class="notification is-primary">
